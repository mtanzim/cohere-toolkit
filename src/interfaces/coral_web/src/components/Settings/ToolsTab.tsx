      ...
      <article className={cn('flex flex-col gap-y-5 pb-10')}>
        ...
        {unavailableTools.length > 0 && (
          <>
            ...
            <div className="flex flex-col gap-y-5">
              {unavailableTools.map(({ name, description, error_message }) => {
                return (
                  <ToggleCard
                    key={name}
                    disabled
                    ...
                    checked={false}
                    label={TOOL_ID_TO_DISPLAY_INFO[name]?.name ?? name}
        ...
        {availableTools.length > 0 && (
          <>
            ...
            <div className="flex flex-col gap-y-5">
              {availableTools.map(({ name, is_available, description, error_message }) => {
